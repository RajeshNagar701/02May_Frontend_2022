                            ...
                            <div className="mb-5">
                                ...
                                <div className="bg-primary p-4">
                                    <div className="d-flex overflow-hidden mb-3">
                                        <img className="img-fluid flex-shrink-0" src="img/blog-1.jpg" style={{ width: 75 }} alt />
                                        <a href className="d-flex align-items-center bg-white text-dark fs-5 fw-bold px-3 mb-0">Lorem ipsum dolor sit amet elit
                                        </a>
                                    </div>
                                    <div className="d-flex overflow-hidden mb-3">
                                        <img className="img-fluid flex-shrink-0" src="img/blog-2.jpg" style={{ width: 75 }} alt />
                                        <a href className="d-flex align-items-center bg-white text-dark fs-5 fw-bold px-3 mb-0">Lorem ipsum dolor sit amet elit
                                        </a>
                                    </div>
                                    <div className="d-flex overflow-hidden mb-3">
                                        <img className="img-fluid flex-shrink-0" src="img/blog-3.jpg" style={{ width: 75 }} alt />
                                        <a href className="d-flex align-items-center bg-white text-dark fs-5 fw-bold px-3 mb-0">Lorem ipsum dolor sit amet elit
                                        </a>
                                    </div>
                                    <div className="d-flex overflow-hidden mb-3">
