            ...
            <section className="title-bar">
                ...
                <div className="full-screen">
                    <section className="full-top">
                        <button id="toggle"><i className="fa fa-arrows-alt" aria-hidden="true" /></button>
                    </section>
                </div>
                <div className="w3l_search">
                    <form action="#" method="post">
                        <input type="text" name="search" defaultValue="Search" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Search';}" required />
                                ...
                                <li className="dropdown profile_details_drop">
                                    <a href="#" className="dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                                        <div className="profile_img">
                                            <span className="prfil-img"><i className="fa fa-user" aria-hidden="true" /></span>
                                            <div className="clearfix" />
                                        </div>
                                    </a>
